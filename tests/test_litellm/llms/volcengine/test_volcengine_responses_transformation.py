...
import litellm
from litellm.llms.volcengine.responses_transformation import VolcEngineResponsesAPIConfig
...
class TestVolcengineResponsesAPITransformation:
    ...
    def test_parallel_tool_calls_dropped(self):
        ...
        mapped = config.map_openai_params(
            response_api_optional_params=params, model="volcengine/demo-model", drop_params=False
        )
