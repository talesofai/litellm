...
class TestVolcengineResponsesAPITransformation:
    ...
    def test_unsupported_params_raise_clear_error(self):
        """Unknown fields should raise an explicit error before send."""
        config = VolcEngineResponsesAPIConfig()
        ...
        assert "unsupported_custom_param" in message
        assert "extra_body.unsupported_custom_param" in message
    ...
    def test_unsupported_params_raise_clear_error(self):
        """Unknown fields (including extra_body) should raise an explicit error."""
        config = VolcEngineResponsesAPIConfig()
