...
class TestVolcEngineConfig:
    ...
    def test_thinking_parameter_handling(self):
        ...
        # Test 4: thinking disabled - should appear in extra_body
    ...
    def test_e2e_completion(self):
        ...
        with patch.object(
            ...
            assert "extra_body" in mock_create.call_args.kwargs and "thinking" in mock_create.call_args.kwargs.get("extra_body", {}) and mock_create.call_args.kwargs.get("extra_body", {})["thinking"] == "disabled"
